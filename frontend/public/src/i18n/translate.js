...
export const GUEST_PUBLIC_SHELL_UI_KEYS = [
  ...
  "locked.body",
  "locked.action",
  "locked.newProject.title",
  "locked.newProject.body",
  "locked.projects.title",
  "locked.projects.body",
  "locked.manual.title",
  "locked.manual.body",
  "locked.glossary.title",
  "locked.glossary.body",
  "locked.knowledgeBase.title",
  "locked.knowledgeBase.body",
  "demo.cta",
  "demo.title",
  "demo.reset",
  "demo.accountCta",
